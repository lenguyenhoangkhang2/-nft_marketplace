...
describe("NFTMarketplace", function () {
  ...
  describe("Purchasing marketplace item", function () {
    ...
    it("Should update item as sold, pay seller, transfer NFT to buyer, charge fees and emit Bougth event", async function () {
      ...
      // The buyer should be owner of NFT
      expect(await nft.ownerOf(1)).to.equal(addr2.address);

      // Item should marked as sold
    ...
    it("Should fail for invalid item ids, sold items and when not enought ether is paid", async function () {
      ...
      // deployer tries purchesing item 1 after its been sold
      await expect(
        marketplace
          .connect(deployer)
          .purchaseItem(1, { value: totalPriceInWei })
